...
namespace ProductOrderApi.Migrations
{
    ...
    [Migration("20250102152537_Create")]
            ...
            modelBuilder.Entity("ProductOrderApi.Entities.OrderTracking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderId = 1,
                            Status = 1,
                            UpdatedAt = new DateTime(2024, 12, 30, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(7052)
                        },
                        new
                        {
                            Id = 2,
                            OrderId = 1,
                            Status = 2,
                            UpdatedAt = new DateTime(2024, 12, 31, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(7058)
                        },
                        new
                        {
                            Id = 3,
                            OrderId = 1,
                            Status = 3,
                            UpdatedAt = new DateTime(2025, 1, 1, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(7060)
                        },
                        new
                        {
                            Id = 4,
                            OrderId = 2,
                            Status = 1,
                            UpdatedAt = new DateTime(2024, 12, 28, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(7061)
                        },
                        new
                        {
                            Id = 5,
                            OrderId = 2,
                            Status = 2,
                            UpdatedAt = new DateTime(2024, 12, 29, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(7063)
                        },
                        new
                        {
                            Id = 6,
                            OrderId = 2,
                            Status = 3,
                            UpdatedAt = new DateTime(2024, 12, 30, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(7064)
                        },
                        new
                        {
                            Id = 7,
                            OrderId = 2,
                            Status = 6,
                            UpdatedAt = new DateTime(2024, 12, 31, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(7066)
                        },
                        new
                        {
                            Id = 8,
                            OrderId = 3,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 1, 2, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(7067)
                        });
                });
            ...
            modelBuilder.Entity("ProductOrderApi.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "AD268754",
                            CreatedAt = new DateTime(2025, 1, 2, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(6608),
                            Description = "Test description for product 1",
                            IsAvailable = true,
                            ModifiedAt = new DateTime(2025, 1, 2, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(6646),
                            Name = "Product 1",
                            Price = 15.99m,
                            QuantityInStock = 14
                        },
                        new
                        {
                            Id = 2,
                            Code = "FR235467",
                            CreatedAt = new DateTime(2025, 1, 2, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(6650),
                            Description = "Test description for product 2",
                            IsAvailable = true,
                            ModifiedAt = new DateTime(2025, 1, 2, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(6651),
                            Name = "Product 2",
                            Price = 1.50m,
                            QuantityInStock = 3
                        },
                        new
                        {
                            Id = 3,
                            Code = "TY547756",
                            CreatedAt = new DateTime(2025, 1, 2, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(6653),
                            Description = "Test description for product 3",
                            IsAvailable = true,
                            ModifiedAt = new DateTime(2025, 1, 2, 16, 25, 37, 50, DateTimeKind.Local).AddTicks(6654),
                            Name = "Product 3",
                            Price = 24.99m,
                            QuantityInStock = 11
                        });
